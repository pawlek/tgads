...
profileName.textContent = `${telegramAppChatLabs.initDataUnsafe.user.first_name}
...
userid.textContent = `${telegramAppChatLabs.initDataUnsafe.user.id}`; // Отображаем id пользователя
